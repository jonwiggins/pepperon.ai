...
def jackknife(data, fold_count, unify_train, save, save_dir):
    """
    Jackknifs the given dataframe into training and testing sets
...
def test_model(model, probe_method, test_set, test_answer):
    """
...
def grid_search(model_type, probe_method, parameter_to_options, data_set, data_answers, fold_count):
